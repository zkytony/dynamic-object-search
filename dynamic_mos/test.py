...
def test_single(case, ntrials=1, planner_type="pouct",
    ...
    for i in range(ntrials):
        ...
        if dynamics == "goal":
            ...
            motion_spec = {"D": ("adversarial", 0.01),
                            "E": ("adversarial", 0.01)}
        else:
...
if __name__ == "__main__":
    random.seed(90595)
    test_single((8,8,8,1), ntrials=1, planner_type="pouct#preferred", sensor_range=2,
                planning_time=0.9, discount_factor=0.99, dynamics="adversarial",
                max_depth=20)
    # test()
